...
$sql="SELECT * FROM `book` WHERE CONCAT(`bno`, `bname`, `cat`) LIKE '%".$valuetosearch."%'"; 
 ...
 <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav  mt-lg-0 mx-auto ">
      ...
      <li class="nav-item">
        <a style="color: white; font-family:Verdana" class="nav-link" href="dash.php"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
      </li>
...
<th scope="col"><strong>BORROW</strong></th>
</tr>
</thead>
<tbody>
<?php
...
<td>
<a href="invet.php?id=<?php echo $row["bno"]; ?>"><button class="btn-info">Borrow</button></a>
</td>
</tr>
<?php $count++; } ?>
</tbody>
