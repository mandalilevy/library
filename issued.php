...
$sql="SELECT * FROM `issued` WHERE CONCAT(`borower`, `bno`, `bname`, `cat`) LIKE '%".$valuetosearch."%'"; 
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav  mt-lg-0 mx-auto ">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a style="color: white; font-family:Verdana" class="nav-link" href="fined.php">FINED</a>
      </li>
...
<div >
    ...
    <input type="text" name="value_to_search" class="form-group" placeholder="Search Value here">
...
<th scope="col"><strong>BOROWER</strong></th>
<th scope="col"><strong>BOOK NUMBER</strong></th>
<th scope="col"><strong>BOOK NAME</strong></th>
<th scope="col"><strong>CATEGORY</strong></th>
<th scope="col"><strong>DATE BORROWED</strong></th>
<th scope="col"><strong>DATE RETURNED</strong></th>
<th scope="col"><strong>RETURN</strong></th>
<th scope="col"><strong>FINE</strong></th>
</tr>
</thead>
<tbody>
<?php
...
<td>
<a href="del.php?id=<?php echo $row["bno"]; ?>"><i class="fa fa-archive" style="color: blue" aria-hidden="true"></i></i></a>
</td>
<td>
<a href="fine.php?id=<?php echo $row["bno"]; ?>"><i class="fa fa-window-close" style="color: red" aria-hidden="true"></i></i></a>
</td>
</tr>
<?php $count++; } ?>
</tbody>
