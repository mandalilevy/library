...
$name = $_GET['id'];
$query = "SELECT * FROM book WHERE bno='$name'";
 ...
 <form action="" method="post">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="name" name="num"  value="<?php echo $row['bno'] ?>" readonly="readonly">
    </div>
    <div class="form-group col-md-6">
...
if (isset($_POST['add'])) {
$con=mysqli_connect("127.0.0.1","root","","library");
$ch ="SELECT * FROM `borow` WHERE bno='".$_POST['num']."'";
...
$qr ="INSERT INTO `borow`(`name`, `bno`, `bname`, `cat`, `db`, `dr`, `fine`) VALUES ('".$_SESSION['user']."','".$_POST['num']."','".$_POST['bname']."','".$_POST['cat']."','".$_POST['db']."','".$_POST['dr']."','".$_POST['fn']."')";
