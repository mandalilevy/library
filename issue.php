...
$sql="SELECT * FROM `borow` WHERE CONCAT(`name`, `bno`, `bname`, `cat`) LIKE '%".$valuetosearch."%'"; 
$search_result= filtertable($sql);
}
else{
$sql="SELECT * FROM `borow`";
$search_result=filtertable($sql);
...
<td>
<a href="give.php?id=<?php echo $row["bno"]; ?>"><i class="fa fa-check-square" aria-hidden="true"></i></a>
</td>
</tr>
<?php $count++; } ?>
</tbody>
