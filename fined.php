...
$sql="SELECT * FROM `borow` WHERE CONCAT(`borower`, `bno`, `bname`, `cat`) LIKE '%".$valuetosearch."%'"; 
$search_result= filtertable($sql);
}
else{
  $fine = "500 per Day";
$sql="SELECT * FROM `borow` WHERE fine='$fine'";
$search_result=filtertable($sql);
 ...
 <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav  mt-lg-0 mx-auto ">
      ...
      <li class="nav-item">
        <a style="color: white; font-family:Verdana" class="nav-link" href="issued.php"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
      </li>
