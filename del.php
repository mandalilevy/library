    ...
    <div class="row">
      <div class="col-sm-9 col-md-5 col-lg-8 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body" >
              <h5 class="card-title text-center" style="color: blue; font-weight: bolder;">RETURN A BOOK</h5>            
 <form action="" method="post">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="idn" name="cat" value="<?php echo $row['bname'] ?>" readonly="readonly">
    </div>
</div>
...
?>
<div >
     <button type="submit" name="add" class="btn  btn-outline-danger"><i style="color: red" class="fa fa-trash-o" aria-hidden="true"></i></button>
  </div>
</form>
 <?php 
}
...
$qr ="DELETE FROM `issued` WHERE bno='".$_POST['bnum']."' ";
//$result=mysqli_query($con,$qr);
if ($con->query($qr) === TRUE) {
$del="DELETE FROM `borow` WHERE bno='".$_POST['bnum']."'";
